...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-S6ZLT6DF.js"), { isDevelopment } = await import("./local-62JTGJVG.js"), oclif = await import("./lib-E2DSNKUX.js"), { ShopifyConfig } = await import("./custom-oclif-loader-YCFOTKOV.js");
...
async function warnIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderWarning } = await import("./ui-CEJ6R3AV.js");
    renderWarning({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-RXCBZVWU.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-AQFGEPN5.js.map
